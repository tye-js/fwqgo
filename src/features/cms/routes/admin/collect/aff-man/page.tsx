...
async function AffManList({
  ...
  const tableData = listResult.data.map((provider) => ({
    ...
    offerAffUrl: provider.offerAffUrl,
    offerAffParam: provider.offerAffParam,
    offerAffValue: provider.offerAffValue,
    offerAffiliateMode: provider.offerAffiliateMode,
    offerAffiliateProductParam: provider.offerAffiliateProductParam,
