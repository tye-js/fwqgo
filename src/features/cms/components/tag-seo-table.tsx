            ...
            <TableRow key={tag.id}>
              ...
              <TableCell className="max-w-[260px] text-sm">
                {tag.enName || tag.enSlug ? (
                  <div>
                    <p className="font-medium">{tag.enName ?? "未填写英文名"}</p>
              ...
              <TableCell className="text-right">
                <Button variant="outline" size="sm" onClick={() => openEditor(tag)}>
        ...
        <DialogContent className="max-w-3xl">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <label className="text-sm font-medium" htmlFor="tag-seo-description">
                中文 Description
              </label>
              <Input
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-sm font-medium" htmlFor="tag-seo-en-description">
                英文 Description
              </label>
              <Input
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-sm font-medium" htmlFor="tag-seo-en-keywords">
                英文 Keywords
              </label>
              <Input
